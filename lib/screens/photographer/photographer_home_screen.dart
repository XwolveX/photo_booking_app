    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.camera_alt_rounded, color: AppTheme.rolePhotographer, size: 64),
            ...
            Container(
              ...
              decoration: BoxDecoration(color: AppTheme.rolePhotographer.withOpacity(0.15), borderRadius: BorderRadius.circular(20), border: Border.all(color: AppTheme.rolePhotographer.withOpacity(0.4))),
              child: const Text('Photographer', style: TextStyle(color: AppTheme.rolePhotographer, fontWeight: FontWeight.w600)),
            ),
