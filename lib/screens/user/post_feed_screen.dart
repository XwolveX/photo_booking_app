            ...
            if (snap.connectionState == ConnectionState.waiting) {
              return Column(
                  children: List.generate(
                      3, (_) => _SkeletonCard(isDark: isDark)));
            }
            ...
            if (docs.isEmpty) {
              return Padding(
                ...
                child: Column(children: [
                  ...
                  Text(
                      'Các bài viết từ photographer & makeup artist\nsẽ xuất hiện ở đây',
...
// ── Role helpers (dùng chung trong file này) ──────────────────
...
class _PostCardState extends State<_PostCard>
  ...
  Widget build(BuildContext context) {
    ...
    // ← SỬA: dùng helpers thay vì isPhoto ? ... : ...
    final roleColor = _getRoleColor(post.authorRole);
    final roleLabel = _getRoleLabel(post.authorRole);
    final roleIcon = _getRoleIcon(post.authorRole);
    final roleGradient = _getRoleGradient(post.authorRole);
    final hasImage =
    ...
    return AnimatedBuilder(
        ...
        builder: (_, __) => Opacity(
            ...
            child: Column(children: [
              ...
              AspectRatio(
                  aspectRatio: 1,
                  child: Container(color: base.withOpacity(0.1))),
